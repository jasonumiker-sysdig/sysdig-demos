...
#wget -q https://github.com/kubernetes-sigs/cri-tools/releases/download/v1.27.0/crictl-v1.27.0-linux-$ARCH.tar.gz
#tar zxvf crictl-v1.27.0-linux-$ARCH.tar.gz -C /usr/local/bin
#rm -f crictl-v1.27.0-linux-$ARCH.tar.gz
